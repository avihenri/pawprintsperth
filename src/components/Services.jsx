  ...
  return (
    <section className="flex min-h-screen flex-col items-center bg-brand-primary bg-overlay md:bg-walking-paws bg-no-repeat bg-cover" id="services">
        ...
        <div className="w-full mb-8 p-2">
            ...
            <h5 className="text-brand-sand text-center w-11/12 m-auto sm:w-full text-xl sm:text-2xl lg:text-3xl 2xl:text-4xl pb-1 my-6"><span className='uppercase font-bold font-mono'>Group Walks</span> <br /><span className='text-brand-eggShell text-lg lg:text-xl 2xl:text-4xl'>Socialize and Exercise Together</span></h5>
            ...
            <h5 className="text-brand-sand text-center w-11/12 m-auto sm:w-full text-xl sm:text-2xl lg:text-3xl 2xl:text-4xl pb-1 my-6"><span className='uppercase font-bold font-mono'>Puppy Visits</span> <br /><span className='text-brand-eggShell text-lg lg:text-xl 2xl:text-4xl'>Caring for Your Pups While You're Away</span></h5>
