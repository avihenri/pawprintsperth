  ...
  return (
    <section className="flex min-h-screen flex-col items-center bg-brand-primary bg-overlay md:bg-walking-paws bg-no-repeat bg-cover">
        ...
        <div className="w-full mb-8 p-2">
            ...
            <p className="text-brand-eggShell text-center sm:w-9/12 md:7/12 m-auto my-6 text-sm sm:text-lg lg:text-xl 2xl:text-5xl py-4">Before we go on any walks or do any visits with your pup, we will organise a meet &amp; greet with yourself so we can get to know each other first.</p>
            <p className="text-brand-secondary text-center sm:w-7/12 m-auto sm:text-lg lg:text-xl 2xl:text-5xl my-5 uppercase py-4">Check out our price list below</p>
            <img className='w-11/12 m-auto sm:w-1/2 lg:w-1/3 2xl:w-1/2 shadow-2xl my-8 lg:mt-8 2xl:mt-10 border-8 border-brand-secondary' src='/price-list.jpg' />
        </div>
    </section>
  )
}
